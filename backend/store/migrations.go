...
var schemaStatements = []string{
	...
	`CREATE TABLE IF NOT EXISTS push_settings (
		...
		gb_pull_url TEXT NOT NULL DEFAULT '',
	...
	`CREATE TABLE IF NOT EXISTS camera_sources (
		...
		rtmp_url TEXT NOT NULL DEFAULT '',
		gb_pull_url TEXT NOT NULL DEFAULT '',
		gb_device_id TEXT NOT NULL DEFAULT '',
		gb_channel_id TEXT NOT NULL DEFAULT '',
		gb_server TEXT NOT NULL DEFAULT '',
		gb_transport TEXT NOT NULL DEFAULT 'udp',
		onvif_endpoint TEXT NOT NULL DEFAULT '',
		onvif_username TEXT NOT NULL DEFAULT '',
		onvif_password TEXT NOT NULL DEFAULT '',
		onvif_profile_token TEXT NOT NULL DEFAULT '',
	...
	`CREATE TABLE IF NOT EXISTS gb28181_devices (
		...
		last_keepalive_at DATETIME NULL,
	...
	`CREATE TABLE IF NOT EXISTS gb28181_channels (
		id INTEGER PRIMARY KEY AUTOINCREMENT,
		device_row_id INTEGER NOT NULL REFERENCES gb28181_devices(id) ON DELETE CASCADE,
		...
		safety_way INTEGER NOT NULL DEFAULT 0,
		register_way INTEGER NOT NULL DEFAULT 1,
		...
		raw_payload TEXT NOT NULL DEFAULT '',
		updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
		UNIQUE(device_row_id, channel_id)
	);`,
	`CREATE TABLE IF NOT EXISTS gb28181_sessions (
		id INTEGER PRIMARY KEY AUTOINCREMENT,
		device_row_id INTEGER NOT NULL REFERENCES gb28181_devices(id) ON DELETE CASCADE,
		device_id TEXT NOT NULL DEFAULT '',
		...
		sdp_body TEXT NOT NULL DEFAULT '',
		created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
		updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
		ended_at DATETIME NULL
	);`,
	...
	`CREATE INDEX IF NOT EXISTS idx_gb28181_devices_status ON gb28181_devices(status, updated_at);`,
	`CREATE INDEX IF NOT EXISTS idx_gb28181_devices_device_id ON gb28181_devices(device_id);`,
	`CREATE INDEX IF NOT EXISTS idx_gb28181_channels_device ON gb28181_channels(device_row_id, updated_at);`,
	`CREATE INDEX IF NOT EXISTS idx_gb28181_channels_channel_id ON gb28181_channels(channel_id);`,
	`CREATE INDEX IF NOT EXISTS idx_gb28181_sessions_status ON gb28181_sessions(status, updated_at);`,
	`CREATE INDEX IF NOT EXISTS idx_gb28181_sessions_device ON gb28181_sessions(device_row_id, updated_at);`,
